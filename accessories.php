        ...
        <?php else: ?>
            <?php foreach ($accessories as $accessory): ?>
                <div class="product-card">
                    <img src="<?php echo htmlspecialchars($accessory['image_url']); ?>" alt="<?php echo htmlspecialchars($accessory['name']); ?>" class="product-image">
                    <h3 class="product-title"><?php echo htmlspecialchars($accessory['name']); ?></h3>
                    <p class="product-description"><?php echo htmlspecialchars($accessory['description']); ?></p>
                    <div class="product-price">₹<?php echo number_format($accessory['price'], 2); ?></div>
                    <div class="product-actions">
                        <button class="add-to-cart" data-product-id="<?php echo $accessory['id']; ?>">
                            <i class="fas fa-shopping-cart"></i> Add to Cart
                        </button>
                        <button class="add-to-wishlist" data-product-id="<?php echo $accessory['id']; ?>">
